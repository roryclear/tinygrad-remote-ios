...
## notes
- tinygrad's REMOTE API is not stable, there is no guarantee that this will work on the newest commit on tinygrad master. You may have to checkout an older tinygrad commit (from the date of the latest commit in this repo). PR's welcome.
